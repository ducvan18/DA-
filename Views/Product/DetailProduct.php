                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="product-single-thumb">
                                    <div class="swiper-container single-product-thumb single-product-thumb-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a class="lightbox-image" data-fancybox="gallery" href="<?= $product[0]['product_image'] ?>">
                                                    <img src="<?= $product[0]['product_image'] ?>" width="570" height="541" alt="Image-HasTech">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="swiper-container single-product-nav single-product-nav-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?= $product[0]['product_image'] ?>" width="127" height="127" alt="Image-HasTech">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?= $product[0]['product_image'] ?>" width="127" height="127" alt="Image-HasTech">
                                            </div>
                                    ...
                                    <input type="hidden" value="<?= $product[0]['product_id'] ?>" name="product_id" id="product_id" class="product_id">
                                </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="product-single-info">
                                    <h3 class="main-title"><?= $product[0]['product_name'] ?></h3>
                                    <div class="prices">
                                        <span class="price">$<?= $product[0]['product_price'] ?></span>
                                    </div>
                                    ...
                                    <form action="index.php?url=shop-cart" method="post">
                                        <div class="product-color">
                                            <h6 class="title">Color</h6>
                                            <select name="color" id="color" onchange="showSizebyProduct()" class="color-list">
                                        ...
                                        <div class="product-size">
                                            ...
                                            <div name="size" id="" class="size-list">
                                        ...
                                        <div class="product-quick-action">
                                            <div class="qty-wrap">
                                                <div class="pro-qty">
                                                    <input type="text" name="quantity" id="quantity" title="Quantity" value="1">
                                                    <!-- <div class= "dec qty-btn">-</div>
                                                    <div class="inc qty-btn">+</div> -->
                                                </div>
                                            </div>
                                            <input type="hidden" name="product_id" value="<?= $product[0]['product_id'] ?>">
                                            <button type="submit" name="add" class="btn-theme" >Add to Cart</button>
                                        </div>
                                    </form>
                                        ...
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="../public/img/shop/1.webp" width="270" height="274" alt="Image-HasTech">
                                                </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="../public/img/shop/7.webp" width="270" height="274" alt="Image-HasTech">
                                                </a>
                                                <div class="product-action">
                                                    <a class="btn-product-wishlist" href="shop-wishlist.html"><i class="fa fa-heart"></i></a>
                                                    <a class="btn-product-cart" href="shop-cart.html"><i class="fa fa-shopping-cart"></i></a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="../public/img/shop/3.webp" width="270" height="274" alt="Image-HasTech">
                                                </a>
                                                <div class="product-flag">
                                                    <ul>
                                                        <li class="discount">-10%</li>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="../public/img/shop/4.webp" width="270" height="274" alt="Image-HasTech">
                                                </a>
                                                <div class="product-action">
                                                    <a class="btn-product-wishlist" href="shop-wishlist.html"><i class="fa fa-heart"></i></a>
                                                    <a class="btn-product-cart" href="shop-cart.html"><i class="fa fa-shopping-cart"></i></a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="../public/img/shop/5.webp" width="270" height="274" alt="Image-HasTech">
                                                </a>
                                                <div class="product-action">
                                                    <a class="btn-product-wishlist" href="shop-wishlist.html"><i class="fa fa-heart"></i></a>
                                                    <a class="btn-product-cart" href="shop-cart.html"><i class="fa fa-shopping-cart"></i></a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="../public/img/shop/6.webp" width="270" height="274" alt="Image-HasTech">
                                                </a>
                                                <div class="product-flag">
                                                    <ul>
                                                        <li class="discount">-10%</li>
